...
func setupTokenManger(c *cli.Context) (tokenManger.Service, error) {
	  ...
	  if err != nil {
	    fmt.Println("error parsing private key from PEM")
	  }
	  ...
	  if err != nil {
	    fmt.Println("error parsing public key from PEM")
	  }
